...
def get_embedded_header_file_path() -> PathHeader:
	return os.path.join(SRC_DIR, EMBEDDED_HEADER_FILE_NAME)

EMBEDDED_C_FILE_NAME = "embedded.c"

def get_embedded_c_file_path() -> PathC:
	return os.path.join(SRC_DIR, EMBEDDED_C_FILE_NAME)
