...
def get_tu_data_table(build_mode_id: BuildModeId) -> Dict[PathC, TuData]:
	...
	if tu_data_table_raw == None:
		...
		tu_data_table = {c_file_path: TuData.from_raw(tu_data_raw)
			for c_file_path, tu_data_raw in tu_data_table_raw.items()}
		return tu_data_table

def save_tu_data_table(build_mode_id: BuildModeId, tu_data_table: Dict[PathC, TuData]) -> None:
	tu_data_table_raw = {c_file_path: tu_data.get_raw()
		for c_file_path, tu_data in tu_data_table.items()}
	tu_data_table_file_path = get_tu_data_table_file_path(build_mode_id)
