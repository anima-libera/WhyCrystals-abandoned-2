...
def get_build_mode(options: Options) -> BuildMode:
	...
	# The compilation command is used to call the compiler on each c file that has to be
	# compiled/recompiled. The "{c}" part will be replaced by the path to the c file, and
	...
	compilation_command_args.append("-std=c11")
	...
	linking_command_args.append(options.compiler)
