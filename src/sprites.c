...
static SDL_Rect s_sprite_rect_table[] = {
	...
	[SPRITE_TOWER_YELLOW] =     {XY16(0, 4), WH16},
	[SPRITE_TOWER_BLUE] =       {XY16(3, 4), WH16},
	[SPRITE_TOWER_GREEN] =      {XY16(4, 4), WH16},
	[SPRITE_TOWER_WHITE] =      {XY16(5, 4), WH16},
	[SPRITE_TOWER_OFF] =        {XY16(1, 4), WH16},
	[SPRITE_SHOT_BLUE] =        {XY16(0, 5), WH16},
	[SPRITE_SHOT_RED] =         {XY16(2, 5), WH16},
	[SPRITE_BLOB_RED] =         {XY16(3, 5), WH16},
	[SPRITE_ENEMY_EGG] =        {XY16(0, 3), WH16},
	[SPRITE_ENEMY_FLY_PURPLE] = {XY16(0, 2), WH16},
	[SPRITE_ENEMY_FLY_RED] =    {XY16(2, 2), WH16},
